...
using extensions.unity.mouse.parallax.Installer.SimpleJSON;

namespace extensions.unity.mouse.parallax.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/extensions.unity.mouse.parallax.Installer.Tests/test_manifest.json";
        const string PackageId = "extensions.unity.mouse.parallax";
